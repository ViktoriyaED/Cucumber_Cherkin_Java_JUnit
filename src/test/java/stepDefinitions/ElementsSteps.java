...
public class ElementsSteps {
    ...
    public void userClicksOnTheSubmitButton() {
        ...
        wait5.until(ExpectedConditions.visibilityOf(submitButton));
        wait5.until(ExpectedConditions.elementToBeClickable(submitButton)).click();
    }
    ...
    public void userShouldSeeConfirmationMessageContaining(String expectedConfirmationMessage) {
        ...
        wait5.until(ExpectedConditions.visibilityOfAllElements(confirmationMessageList));
